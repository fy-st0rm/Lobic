    ...
    return (
          ...
          <div className="flex justify-evenly items-center mt-0 mx-2">
            <div className="flex items-center gap-0 font-bold w-[40%] px-4 py-[2px]">
                <div className="cover h-[66px] w-[66px] py-1 self-start cursor-pointer" onClick={infos.onClick}><img src= {infos.coverImg} alt="" className="h-[66px] w-[66px] cover rounded " /></div>
